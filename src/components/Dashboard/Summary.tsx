    ...
    <div className="space-y-4">
        ...
        <Card className="glass p-4 border-none glow-blue">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-lg text-white">Info Pengantaran</h3>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="bg-white/5 rounded-xl py-2">
              <p className="text-muted-foreground text-[10px] uppercase font-black">Total</p>
              <p className="text-xl font-black text-white">{'totalBuyer' in activeStats ? activeStats.totalBuyer : activeStats.total}</p>
            </div>
            <div className="bg-green-500/20 rounded-xl py-2">
            ...
            <div className="bg-red-500/20 rounded-xl py-2">
        ...
        <Card className="glass p-4 border-none glow-orange">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-lg text-white">Info Doi</h3>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button 
          ...
          className="h-14 bg-white/10 hover:bg-white/20 text-white font-black rounded-2xl border border-white/10 shadow-md gap-2 active:scale-95 transition-all"
        >
        ...
        <div className="relative">
          ...
          />
          <Button 
            className="w-full h-14 bg-white/10 hover:bg-white/20 text-white font-black rounded-2xl border border-white/10 shadow-md gap-2 active:scale-95 transition-all"
          >
